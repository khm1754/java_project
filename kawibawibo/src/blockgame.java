...
public class blockgame extends JFrame {
      ...
      //constant
       ...
       int BAR_WIDTH = 80;
       int BAR_HEIGHT = 20;
       int CANVAS_WIDTH = 400 + (BLOCK_GAP * BLOCK_COLUMNS) - BLOCK_GAP;
      ...
      //variable
       ...
       int score = 0;
       Timer timer = null;
       Block[][] blocks = new Block[BLOCK_ROWS][BLOCK_COLUMNS];
       Bar bar = new Bar();
       Ball ball = new Ball();
       int barXTarget = bar.x; //Target Value - interpolation
       int dir = 0; //0 : Up-Right 1 : Down-Rigth 2 : Up-Left 3 : Down-Left
       int ballSpeed = 5;
      ...
      class MyPanel extends JPanel { //VANVAS for Draw!
         public MyPanel() {
